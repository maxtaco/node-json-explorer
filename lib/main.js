...
(function() {
  ...
  Runner = (function() {
    ...
    Runner.prototype.output = function(arg, cb) {
      var json, ret;
      json = arg.json;
      ret = typeof json === 'string' ? this.b64decode ? (new Buffer(json, "base64")).toString('utf8') : json : typeof json === 'object' ? Array.isArray(json) && this.count ? json.length.toString('10') : this.json_format(json) : typeof json === 'number' ? json.toString('10') : void 0;
      return cb(null, ret);
    };

    Runner.prototype.parse_input = function(arg, cb) {
      var __iced_it, __iced_passed_deferral, buf;
      buf = arg.buf;
      ...
      __iced_it = (function(_this) {
        ...
        return function*() {
          ...
          if (_this.unpack) {
            ret = err = null;
            try {
              ret = _this.b64encode_buffers(unpack(Buffer.from(s, "base64")));
            } catch (error) {
              e = error;
              err = e;
            }
            ...
            __iced_deferrals = new iced.Deferrals(__iced_it, {
              ...
              funcname: "Runner.parse_input.<anonymous: Runner>",
              filename: "/Users/max/src/misc/node-json-explorer/src/main.iced"
            });
            a_json_parse(s, __iced_deferrals.defer({
              assign_fn: (function() {
                return function() {
                  err = arguments[0];
