...
(function() {
  ...
  Runner = (function() {
    ...
    Runner.prototype.output = function(arg, cb) {
      var json, ret;
      json = arg.json;
      ret = typeof json === 'string' ? this.b64decode ? (new Buffer(json, "base64")).toString('utf8') : json : typeof json === 'object' ? Array.isArray(json) && this.count ? json.length.toString('10') : this.inspect ? util.inspect(json, {
        depth: this.depth
